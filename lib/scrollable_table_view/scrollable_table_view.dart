...
class ScrollableTableView extends StatefulWidget {
  ...
  final ScrollController? verticalScrollContoller;
...
class _ScrollableTableViewState extends State<ScrollableTableView> {
  ...
  late final _verticalScrollController1 = widget.verticalScrollContoller ?? ScrollController();
  ...
  List<TableViewRow> _getPaginatedRows(int? page) {
    ...
    if (page > widget.paginationController!.pageCount) {
      debugPrint("page $page is out of range!!! ${widget.paginationController!.pageCount} pages available");
      return [];
    }
  ...
  double get _contentHeight {
    ...
    List<TableViewRow> rows = widget.paginationController == null ? widget.rows : _getPaginatedRows(null);
  ...
  Widget build(BuildContext context) {
    if (widget.paginationController != null && widget.paginationController!.rowCount != widget.rows.length) {
      throw FlutterError("failed assertion: widget.paginationController!.recordCount != widget.rows.length");
    }
...
class TableViewRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var tableViewState = context.findAncestorStateOfType<_ScrollableTableViewState>();
