...
class UsersTable extends StatelessWidget {
  UsersTable({super.key, required this.data, required this.updateCallback, required this.shoudUpdate});

  ObservableList<PersonViewModel> data;

  Future<void> Function() updateCallback;
  bool Function() shoudUpdate;
